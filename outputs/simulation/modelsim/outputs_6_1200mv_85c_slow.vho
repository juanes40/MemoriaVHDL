...
-- writen	=>  Location: PIN_Y10,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF outputs IS
...
-- Equation(s):
-- \U3~1_combout\ = (\address[7]~input_o\ & (\address[6]~input_o\ & (\writen~input_o\ & \address[5]~input_o\)))
